...
function switchTab(t) {
  ...
  const map_t = {list:'tp-list', add:'tp-add', edit:'tp-edit', global:'tp-global', mapa:'tp-mapa', 'zonas-admin':'tp-zonas-admin', roadmap:'tp-roadmap', cats:'tp-cats', groups:'tp-groups'};
  const el = document.getElementById(map_t[t]);
  if (el) el.classList.add('on');
  if (t === 'mapa') initMapaTab();
}
