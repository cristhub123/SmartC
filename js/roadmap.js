...
const ROADMAP = [
  ...
  { id:'r28', status:'idea', priority:'low', title:'Temporadas temáticas masivas (reskins de edificios)',
    desc:'Cada edificio mantiene su pin genérico base + variantes temáticas identificadas por sufijo en el nombre de archivo (ej. "cabildo-de-cordoba_ataque-dragones"). Requiere evolucionar el guardado de imágenes de 4 casilleros fijos a una lista abierta con etiqueta de temática. Panel admin: detecta temáticas automáticamente y permite activar cada una en 2 modos — (A) como variante opcional en el carrusel del usuario, o (B) como imagen PRINCIPAL del pin en todo el mapa por tiempo limitado (eventos/temporadas tipo "skins" de temporada). Depende de Firebase/Firestore ya conectado (r11). ~7-10 hs.' },
