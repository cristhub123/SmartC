...
/* ─────────────────────────────────────────
   ADMIN TAB — Eventos → sección "Filtro de fecha de eventos" (se suma
   como un plugin más de la tab 'eventos-admin', ver js/eventos.js —
   SC.registerTabPlugin acumula, no reemplaza). Movido desde la tab
   'mapa' el 05/09 — es un ajuste conceptual de Eventos, no del mapa.
   ───────────────────────────────────────── */
